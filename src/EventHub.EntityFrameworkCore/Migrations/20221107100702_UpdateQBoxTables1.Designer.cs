...
namespace EventHub.Migrations
{
    ...
    [Migration("20221107100702_UpdateQBoxTables1")]
    partial class UpdateQBoxTables1
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EventHub.Knowledges.Categories.Major", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("EventHub.Knowledges.Categories.Subject", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("EventHub.Organizations.Mentees.Bookings.Question", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("DirectoryRoot")
                        .IsRequired()
                        .HasMaxLength(256)
            ...
            modelBuilder.Entity("EventHub.Organizations.Mentees.Mentee", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("EventHub.Organizations.Mentors.Mentor", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("EventHub.Organizations.Mentors.Profiles.Certificate", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid?>("MentorSkillId1")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("MentorSkillId1");

                    b.HasIndex("Accomplishment", "Issuer")
                        .IsUnique();

                    b.ToTable("Certificate", (string)null);
                });

            modelBuilder.Entity("EventHub.Organizations.Mentors.Profiles.MentorSkill", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<bool>("IsQBoxApprovedSkill")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(false);
            ...
            modelBuilder.Entity("EventHub.Organizations.Mentors.Slots.Slot", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("EventHub.Knowledges.Categories.Subject", b =>
                {
                    b.HasOne("EventHub.Knowledges.Categories.Major", null)
                        .WithMany()
            ...
            modelBuilder.Entity("EventHub.Organizations.Mentees.Bookings.Booking", b =>
                {
                    ...
                    b.HasOne("EventHub.Organizations.Mentors.Slots.Slot", null)
                        .WithMany()
            ...
            modelBuilder.Entity("EventHub.Organizations.Mentees.Bookings.Question", b =>
                {
                    b.HasOne("EventHub.Organizations.Mentees.Bookings.Booking", null)
                        .WithMany()
            ...
            modelBuilder.Entity("EventHub.Organizations.Mentors.Profiles.Certificate", b =>
                {
                    b.HasOne("EventHub.Organizations.Mentors.Profiles.MentorSkill", null)
                        .WithMany()
                    ...
                    b.HasOne("EventHub.Organizations.Mentors.Profiles.MentorSkill", null)
                        ...
                        .HasForeignKey("MentorSkillId1");
                });

            modelBuilder.Entity("EventHub.Organizations.Mentors.Profiles.MentorSkill", b =>
                {
                    b.HasOne("EventHub.Organizations.Mentors.Mentor", null)
                        .WithMany("MentorSkills")
                        .HasForeignKey("MentorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EventHub.Knowledges.Categories.Subject", null)
                        .WithMany()
